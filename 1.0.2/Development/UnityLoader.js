...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = '1.0.2.data';
    var REMOTE_PACKAGE_BASE = '1.0.2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 22035463;
      var PACKAGE_UUID = '09c074b6-588a-41e6-af88-646295a1d152';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 19150867, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(19150867, 19151943, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(19151943, 19159062, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(19159062, 21132866, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(21132866, 22007838, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(22007838, 22035463, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_1.0.2.data');

    };
    Module['addRunDependency']('datafile_1.0.2.data');
